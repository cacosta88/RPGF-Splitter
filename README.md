...
#### Project data sourced from [growthepie](https://www.growthepie.xyz/optimism-retropgf-3) as of December 2023. Here is the dataset being used in this repo: [projects.json](https://github.com/cacosta88/RPGF-Splitter/blob/master/packages/nextjs/public/assets/projects.json)
#### [ProjectSplitter.tsx](https://github.com/cacosta88/RPGF-Splitter/blob/master/packages/nextjs/components/splitter-ui/ProjectSplitter.tsx) contains the core component.
